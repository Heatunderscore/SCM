...
class PlayState extends MusicBeatState
{
			...
			case 'sucktion':
				{
						defaultCamZoom = 0.87;
						curStage = 'sucktion';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('SCM/back/bg'));
						bg.antialiasing = true;
						bg.screenCenter(X);
						bg.screenCenter(Y);
						...
						overlay = new FlxSprite(-500, -300).loadGraphic(Paths.image('SCM/back/overlay'));
	...
	function endSong():Void
	{
		...
		else
		{
			if (isStoryMode)
			{
				...
				{
					if (curSong.toLowerCase() == 'fuck-you'){
	...
	*/
	...
	override function beatHit()
	{
		...
		/*if (curSong.toLowerCase() == 'tower' && curBeat == 201) {
			boyfriend.y -= 1500;
		}*/
